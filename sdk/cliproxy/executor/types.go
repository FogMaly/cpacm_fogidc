...
// StrictPublicModelRoutingMetadataKey disables cross-model remapping for strict public routes.
const StrictPublicModelRoutingMetadataKey = "strict_public_model_routing"

// SessionAffinitySeedMetadataKey stores a synthetic per-client affinity seed when
// the inbound request does not provide an explicit conversation/session identifier.
const SessionAffinitySeedMetadataKey = "session_affinity_seed"
