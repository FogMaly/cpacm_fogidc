...
type AmpModule struct {
	...
	userRouteInterceptor func(*gin.Context) bool
...
// WithUserRouteInterceptor intercepts /api/user routes before they are proxied upstream.
func WithUserRouteInterceptor(fn func(*gin.Context) bool) Option {
	return func(m *AmpModule) {
		m.userRouteInterceptor = fn
	}
}
