...
var (
	...
	geminiOAuthScopes           = geminiAuth.Scopes
	antigravityOAuthClientID     = antigravityAuth.ClientID
	antigravityOAuthClientSecret = antigravityAuth.ClientSecret
	antigravityOAuthTokenURL     = antigravityAuth.TokenEndpoint
)
