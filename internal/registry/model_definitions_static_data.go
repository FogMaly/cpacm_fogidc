...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			DisplayName:         "GPT 5.4",
			Description:         "Advanced coding and agentic model with improved frontier capabilities.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"none", "low", "medium", "high", "xhigh"}},
		},
		{
			...
			Description:         "Higher-capability GPT 5.4 variant for complex coding and reasoning workloads.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"none", "low", "medium", "high", "xhigh"}},
